...
var _panels = {
  settings: {
    open: function(){ document.getElementById('settingsOverlay').classList.add('open'); _updateSettingsThemeBtns(); _updateSettingsAutoplay(); _updateSettingsSpeedBtns(); _updateSettingsGoogleUI(); _updateSettingsAiKeyUI(); if(typeof _updateSettingsWaterToggle==='function') _updateSettingsWaterToggle(); },
