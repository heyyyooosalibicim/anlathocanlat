...
var _panels = {
  settings: {
    open: function(){ document.getElementById('settingsOverlay').classList.add('open'); _updateSettingsThemeBtns(); _updateSettingsAutoplay(); _updateSettingsSpeedBtns(); _updateSettingsGoogleUI(); _updateSettingsAiKeyUI(); _updateSettingsStopDailyHideToggle(); if(typeof _updateSettingsWaterToggle==='function') _updateSettingsWaterToggle(); },
...
function testMidnightReset(){
  ...
  // --- checkMidnightReset ile BİREBİR AYNI KOD (bkz. features.js → BİRLEŞİK GÜNLÜK ARŞİV) ---
