...
var AHA_OFFLOAD_MIN_BYTES = 40 * 1024;   // kota aşılınca bu boyuttan büyük data-URI alanları Drive adayı sayılır
...
/* localStorage.setItem'in yerine geçen genel amaçlı fonksiyon: önce normal
   ...
   dener. HER save fonksiyonunda (saveAll, ileride saveNotes/saveAiFlashcards
   vb.) localStorage.setItem(KEY,JSON.stringify(x)) yerine ahaSafeSetItem(KEY,x)
   kullanılabilir — şemadan bağımsız çalışır. */
