...
function renderStatsTab(body){
  ...
  var allHistoryKeys=Object.keys(archiveData).sort();
  ...
  // Bar chart — covers ALL arşiv günleri + bugün (artık gerçekten 60 günü gösterebiliyor,
  // eskiden ÖZETLER 30 günde silindiği için bu sınıra hiç ulaşamıyordu)
  var allHistoryDates=Object.keys(archiveData).filter(function(d){return archiveData[d].watch;}).sort(); // oldest first
